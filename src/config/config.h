...
#define SERVO_SWEEP_TASK_PRI 0
#define LIDAR_SWEEP_TASK_PRI 0
...
#define SERVO_SWEEP_TASK_NAME "SERVO SWEEP"
#define LIDAR_SWEEP_TASK_NAME "LIDAR SWEEP"
...
#define SERVO_SWEEP_TASK_STACKSIZE configMINIMAL_STACK_SIZE
#define LIDAR_SWEEP_TASK_STACKSIZE configMINIMAL_STACK_SIZE
